...
@Component({
  selector: 'app-visitas-inmediatas',
  templateUrl: './visitas-inmediatas.page.html',
  styleUrls: ['./visitas-inmediatas.page.scss'],
  standalone: false,
})
export class VisitasInmediatasPage implements OnInit {
  results: any;
  usuario = ""
  ...
  constructor( 
    private VistarInmediato: ClientesService,
  ...
  ngOnInit() {
    ...
    this.results = this.VistarInmediato.searchVisitarInmediatos(this.usuario);
